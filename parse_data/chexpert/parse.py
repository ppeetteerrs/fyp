...
CHEXPERT_TRAIN_LMDB.mkdir(parents=True, exist_ok=True)
CHEXPERT_TEST_LMDB.mkdir(parents=True, exist_ok=True)

TRAIN_CSV = CHEXPERT_DIR / "train.csv"
TEST_CSV = CHEXPERT_DIR / "valid.csv"
...
if __name__ == "__main__":
    ...
    proc_df(train_df, CHEXPERT_DIR, CHEXPERT_TRAIN_LMDB)

    print("Processing test images...")
    proc_df(test_df, CHEXPERT_DIR, CHEXPERT_TEST_LMDB)
