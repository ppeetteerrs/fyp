...
from psp.encoder_deep import EncoderDeep
...
class pSp(nn.Module):
    def __init__(self, ckpt: Dict[str, Any]):
        ...
        # Define architecture
        self.encoder = EncoderDeep(len(CONFIG.PSP_IN), CONFIG.RESOLUTION).to("cuda")
    ...
    def mix(self, inputs: Tuple[Tensor, Tensor]) -> Tuple[Tensor, Tensor]:
